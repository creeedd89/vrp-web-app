  ...
  return (
    <div>
      <TopBar
        ...
        subtitle="VRP analysis across all major stock exchanges"
      />
              ...
              {region.markets.map((market) => {
                const vrpColor =
                  market.vrp > 6
                    ...
                    : "var(--positive)";
                return (
                  <div key={market.id} className="glass-card p-5 cursor-pointer">
                    ...
                    <div className="flex items-end justify-between">
                      <div>
                        ...
                        <div className="text-lg font-bold" style={{ color: "var(--text-primary)" }}>
                          {market.indexValue.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-4 pt-3 border-t" style={{ borderColor: "var(--border-subtle)" }}>
                      <div>
